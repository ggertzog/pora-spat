...
import { IReview, useReviewsQuery } from "@/core/api/queryFetchers/getReviewsQuery";
...
export default function ReviewsSection({ className, isHomePage = false }: ReviewsSectionProps) {
  ...
  return (
    <section className={clsx(styles.reviewsSection, className)}>
