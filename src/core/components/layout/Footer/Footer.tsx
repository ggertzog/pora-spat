...
export const Footer = () => {
  ...
  const renderFooterContent = () => {
    return isXlLayout ? (
      <XlFooterContent catalogItems={catalogItems} customersItems={customersItems} contactItems={contactItems} />
    ) : isMdLayout ? (
      <MdFooterContent catalogItems={catalogItems} customersItems={customersItems} contactItems={contactItems} />
    ) : (
      <XsFooterContent contactItems={contactItems} />
    );
  };
